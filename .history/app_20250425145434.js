...
render() {
  this.innerHTML = `
    <section class="py-[80px] px-[150px] max-3x;:py-[40px] max-3x;:px-[20px]">
      <div>
        <div class="flex justify-between mb-4 items-center">
          <h3 class="font-bold text-[20px] max-3x;:text-[16px]">Lançamentos</h3>
          <a href="#" class="font-bold max-3x;:underline max-3x;:mt-2 text-[16px] max-3x;:text-[14px]">Ver mais</a>
        </div>
        <div class="swiper">
...
class Description extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
     <section class="flex max-3x;:flex-col px-[200px] gap-5 items-center max-3x;:px-0">
        <div class="flex bg-(--bg-dark) justify-center items-center">
            <img src="./assets/mug.svg" alt="Foto de uma caneca da Avanti" />
        </div>
        <div class="font-(--font-secondary) w-1/2 max-3x;:w-4/5">
            <h1 class="font-bold text-[30px] max-3x;:m-3">
          LOREM IPSUM
            </h1>
            <p class="text-[12px] max-3x;:leading-5">
