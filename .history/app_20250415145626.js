    ...
    render() {
      this.innerHTML = `
        <section class="py-[80px] px-[150px] max-md:py-[40px] max-md:px-[20px]">
          <div>
            <div class="flex justify-between mb-4 max-md:flex-col max-md:items-center">
              <h3 class="font-bold text-[20px] max-md:text-[16px]">Lançamentos</h3>
              <h4 class="max-md:mt-2 text-[16px] max-md:text-[12px]">Ver mais</h4>
            </div>
            <div class="swiper">
...
initSwiper() {
  new Swiper(this.querySelector(".swiper-container"), {
    ...
    breakpoints: {
      768: { slidesPerView: 2, spaceBetween: 10 }, // For screens smaller than 768px
      1024: { slidesPerView: 3, spaceBetween: 15 }, // For screens smaller than 1024px
    },
  });
}
