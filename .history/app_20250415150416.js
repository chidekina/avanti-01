...
class Description extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
     <section class="flex max-md:flex-col px-[200px] gap-5 items-center max-md:w-full">
        <div class="flex bg-(--bg-dark) justify-center items-center max-md:w-full">
            <img src="./assets/mug.svg" alt="Foto de uma caneca da Avanti" class="max-md:w-full" />
        </div>
