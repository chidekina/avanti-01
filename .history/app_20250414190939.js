...
function generateDepartmentContent(departmentId) {
  ...
  if (currentVisibleId === departmentId.toString()) {
    depContent.classList.add('hidden'); // Hide the department content
    depContent.removeAttribute('data-visible-id');
    console.log('Hiding department content'); // Debugging log

    if (!dropdown.classList.contains('hidden')) {
      dropdown.classList.add('hidden'); // Hide the dropdown
      console.log('Hiding dropdown'); // Debugging log
    }
    return;
  }

  depContent.setAttribute('data-visible-id', departmentId);
  depContent.classList.remove('hidden'); // Show the department content
  console.log('Showing department content for ID:', departmentId); // Debugging log
