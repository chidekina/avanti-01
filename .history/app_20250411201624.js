...
for (let i = 1; i <= 15; i++) {
  ...
  li.className = 'flex justify-between hover:text-(--primary-color) active:font-bold active:text-(--primary-color) active:font-bold';
  li.innerHTML = `
    <p>Departamento</p>
    <img src="./assets/arrow.svg" alt="imagem de flecha" />
  `;
  categories.appendChild(li); // Append instead of overwriting
}