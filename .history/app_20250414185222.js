...
function generateDepartmentContent(departmentId) {
  // Clear only the <h2> inside #department-number
  const existingH2 = depNumber.querySelector('h2');
  if (existingH2) {
    depNumber.removeChild(existingH2);
  }

  // Clear the content of #department-content-list
  depContentList.innerHTML = '';

  // Create and prepend the new <h2>
