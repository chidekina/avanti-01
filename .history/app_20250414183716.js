...
const depContentSubList = document.getElementById('department-content-sublist');
...
function generateDepartmentContent(departmentId) {
  ...
  depContentSubList.innerHTML = `        <h2 class="font-bold mt-4 mb-2">
  ...
  for (let col = 1; col <= 3; col++) {
    ...
    depContentSubList.appendChild(ul);
  }
}
...
for (let i = 1; i <= 7; i++) {
  const li = document.createElement('li');
  li.innerHTML = `
    <a href="#" id="dep-${i}"> Departamento ${i} </a>
  `;
